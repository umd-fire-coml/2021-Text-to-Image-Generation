...
def write_log(callback, name, loss, batch_no):
    ...
    """
    callback.writer = tf.summary.create_file_writer("logs");
...
if __name__ == '__main__':
    ...
    if not(os.path.isdir("CUB_200_2011/")):
        gdown.download("https://drive.google.com/u/0/uc?id=1hbzc_P1FuxMkcabkgn9ZKinBwW683j45&export=download", 'CUB_200_2011.tgz', quiet=False)
        print(os.listdir())
        tar = tarfile.open('CUB_200_2011.tgz', 'r:gz')
        tar.extractall()
        tar.close()
    if not(os.path.exists("birds/test/char-CNN-RNN-embeddings.pickle")):
        gdown.download("https://drive.google.com/u/1/uc?id=1GTvZs9zRdRrCFwLVqN_-8WclO2chHU1C&export=download", 'birds/test/char-CNN-RNN-embeddings.pickle', quiet=False)
    if not(os.path.exists("birds/train/char-CNN-RNN-embeddings.pickle")):
        gdown.download("https://drive.google.com/u/1/uc?id=1GTvZs9zRdRrCFwLVqN_-8WclO2chHU1C&export=download", 'birds/train/char-CNN-RNN-embeddings.pickle', quiet=False)
    # Define optimizers
